...
cmd_help() {
  ...
  Examples:
    ...
    ./scripts/blob_browser.sh ls compliance compliance_assessment/45e249e8-fa77-4fca-b8d8-f3b26c3df416/
    ./scripts/blob_browser.sh tree compliance compliance_assessment/
    ./scripts/blob_browser.sh exists compliance compliance_assessment/.../policy.pdf
    ./scripts/blob_browser.sh url compliance compliance_assessment/.../policy.pdf
